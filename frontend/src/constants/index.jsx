export const features = [
  {
    ...
    caption: "Soluções Flexíveis",
    title: "Otimize a gestão do seu negócio",
    text: "Com a JURISTA MASTER, tarefas manuais são eliminadas. A automatização e os processos inteligentes vão transformar a sua produtividade. É como ter um assistente extra, mas sem as complicações.",
    button: {
      icon: "/images/magictouch.svg",
      title: "Assista à demonstração",
    },
  },
  {
    id: "1",
    ...
    title: "Tranquilidade total para sua empresa",
    text: "A segurança dos seus dados é nossa prioridade. Com criptografia de última geração e controles rigorosos de privacidade, a JURISTA MASTER mantém suas informações protegidas, com a confiança de um cofre forte.",
    button: {
...
export const details = [
  {
    ...
    title: "Plataforma com atualizações constantes",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Colabore com sua equipe de forma eficiente",
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "Sistema de backup automatizado e seguro",
  },
  {
    id: "3",
...
export const faq = [
  {
    id: "0",
    question: "Quão fácil é configurar a plataforma JURISTA MASTER?",
    answer:
      "A configuração é simples e intuitiva. Nossa plataforma foi projetada para ser fácil de usar, permitindo que você inicie rapidamente a gestão do seu negócio com eficiência.",
  },
  {
    id: "1",
    question: "Posso integrar a JURISTA MASTER com outras plataformas?",
    answer:
      "Sim, nossa plataforma oferece integração com diversas ferramentas e sistemas, permitindo que você centralize todos os processos em um único lugar e otimize sua gestão.",
  },
  {
    id: "2",
    question: "Com que frequência vocês adicionam novas funcionalidades?",
    answer:
      "Estamos constantemente atualizando nossa plataforma para garantir que você tenha acesso a novas funcionalidades e melhorias. A cada atualização, novas ferramentas são adicionadas para melhorar sua experiência.",
  },
  {
    id: "3",
    question: "Qual é a política de reembolso?",
    answer:
      "Oferecemos uma política de reembolso simples e transparente. Caso você não esteja satisfeito com o serviço, entre em contato conosco dentro do período de garantia para solicitar um reembolso.",
  },
  {
    id: "4",
    question: "Vocês têm planos corporativos?",
    answer:
      "Sim, oferecemos planos especiais para empresas de diferentes portes, com recursos avançados para gerenciamento de equipes e dados. Entre em contato para mais informações sobre planos corporativos.",
  },
  {
    id: "5",
    question: "O que acontece quando ultrapasso o limite de armazenamento?",
    answer:
      "Se você atingir o limite de armazenamento, poderá escolher entre atualizar seu plano ou fazer uma limpeza nos dados para liberar espaço. Notificações serão enviadas para garantir que você não fique sem espaço.",
  },
  {
    id: "6",
    question: "Posso fazer upgrade no meu plano?",
    answer:
      "Sim! Você pode atualizar seu plano a qualquer momento para acessar mais recursos e melhorar a performance de sua plataforma. Todos os upgrades são feitos de forma simples e transparente.",
  },
  {
    id: "7",
    question: "Como posso convidar minha equipe para a plataforma?",
    answer:
      "Você pode facilmente convidar membros da sua equipe através da opção de gerenciamento de usuários, onde poderá definir permissões de acesso e facilitar a colaboração.",
  },
  {
    id: "8",
    question: "Vocês oferecem treinamento para indivíduos e equipes?",
    answer:
      "Sim, oferecemos treinamentos personalizados para indivíduos e equipes. Nossos tutoriais e suporte ao vivo garantem que todos possam usar a plataforma de forma eficiente.",
  },
  {
    id: "9",
    question: "Estou bloqueado da minha conta, o que faço?",
    answer:
      "Caso você tenha problemas para acessar sua conta, entre em contato com nossa equipe de suporte ao cliente, que ajudará a recuperar o acesso rapidamente. Temos suporte disponível 24/7 para assisti-lo.",
  },
];
...
export const plans = [
  {
    ...
    title: "Plano Start",
    priceMonthly: 60,
    priceYearly: 600, // O valor anual é calculado com desconto de 10%
    caption: "Inicie seu negócio de forma automatizada",
    features: [
      "Gerencie até 20 clientes",
      "Painel simplificado para controle de dados",
      "Cadastro de clientes e controle de empréstimos",
  ...
  },
  {
    ...
    title: "Plano Plus",
    priceMonthly: 90,
    priceYearly: 900, // O valor anual é calculado com desconto de 10%
    caption: "Organize e controle mais clientes de forma eficiente",
    features: [
      "Todos os recursos do Plano Start",
      "Gerencie até 50 clientes",
      "Controle completo de cobanças e pagamentos",
      "Relatórios e análises financeiras detalhadas",
      "Acesso a funcionalidades de gestão de empréstimos",
    ],
  ...
  },
  {
    ...
    title: "Plano Básico",
    priceMonthly: 153,
    priceYearly: 1530, // O valor anual é calculado com desconto de 10%
    caption: "Pague menos e use mais para empresas com muitos clientes",
    features: [
      "Todos os recursos do Plano Plus",
      "Gerencie até 100 clientes",
      "Análises financeiras avançadas e relatórios personalizados",
      "Gestão de múltiplos tipos de empréstimos",
      "Painel de afiliados e comissão de vendas",
      "Suporte dedicado e prioridade",
    ],
...
export const testimonials = [
  {
    ...
    comment:
      "O suporte ao cliente da JURISTA MASTER é excepcional! Sempre prontos para ajudar quando preciso, tornam nossa gestão financeira muito mais tranquila.",
  },
  {
    id: "1",
    name: "Mark Erixon",
    ...
    comment:
      "Estava cético no começo, mas agora não consigo imaginar nossa gestão de empréstimos sem a JURISTA MASTER. A plataforma realmente faz a diferença.",
  },
  {
    id: "2",
    name: "Melanie Hurst",
    ...
    comment:
      "Adotar esta plataforma foi muito fácil. Tornou as tarefas diárias de controle de clientes e finanças muito mais simples e eficientes.",
  },
  {
    id: "3",
    name: "Alicia Barker",
    ...
    comment:
      "A funcionalidade de análises financeiras é como ter um conselheiro pessoal. Tem sido fundamental para orientar nossas decisões de negócio.",
  },
  {
    id: "4",
    name: "Becky Snider",
    ...
    comment:
      "Mudei para a JURISTA MASTER no mês passado, e já estou vendo resultados. A melhor decisão para nossa gestão financeira!",
  },
  {
    id: "5",
    name: "Jim Bradley",
    ...
    comment:
      "O aumento na eficiência é inegável. A plataforma transformou completamente nosso fluxo de trabalho financeiro, de maneira definitiva.",
  },
];
